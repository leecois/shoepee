[![CI with GitHub Actions using Maven and JUnit | © 2023 by minhchan](https://github.com/leecois/shoe-stylise/actions/workflows/maven.yml/badge.svg)](https://github.com/leecois/shoe-stylise/actions/workflows/maven.yml)
