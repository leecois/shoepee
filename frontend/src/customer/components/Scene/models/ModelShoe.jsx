    ...
    <Bounds fit observe margin={0.8}>
      <group {...props} ref={group} dispose={null}>
        <mesh
          ...
          scale={[
            customization.layerSize.laces.x,
            customization.layerSize.laces.y,
            customization.layerSize.laces.z,
          ]}
        />
        <mesh
          ...
          scale={[
            customization.layerSize.mesh.x,
            customization.layerSize.mesh.y,
            customization.layerSize.mesh.z,
          ]}
          onClick={(e) => handleClick(e)}
        />
        ...
        <mesh
          ...
          onClick={(e) => handleClick(e)}
          scale={[
            customization.layerSize.caps.x,
            customization.layerSize.caps.y,
            customization.layerSize.caps.z,
          ]}
        />
        <mesh
          ...
          onClick={(e) => handleClick(e)}
          scale={[
            customization.layerSize.inner.x,
            customization.layerSize.inner.y,
            customization.layerSize.inner.z,
          ]}
        />
        <mesh
          ...
          onClick={(e) => handleClick(e)}
          scale={[
            customization.layerSize.sole.x,
            customization.layerSize.sole.y,
            customization.layerSize.sole.z,
          ]}
        />
        <mesh
        ...
        <mesh
          ...
          scale={[
            customization.layerSize.band.x,
            customization.layerSize.band.y,
            customization.layerSize.band.z,
          ]}
        />
        <mesh
          ...
          scale={[
            customization.layerSize.patch.x,
            customization.layerSize.patch.y,
            customization.layerSize.patch.z,
          ]}
        />
      </group>
    </Bounds>
